...
aidn.init = {
    ...
    selectBasePath: function(e, t) {
        var n = parseInt(aidn.util.getCookie("baseid")),
            i = e;
        return (isNaN(n) || 1 == t) && (n = Math.floor(Math.random() * i.length), aidn.util.setCookie("baseid", n, 604800)), (i.length <= n || n < 0) && (n = 0), this.basepath = i[n], this.basepath
    },
    ...
    __update: function() {
        for (var e, t = aidn.ref.__list, n = aidn.ref.__total, i = aidn.ref.__interval, a = 0; a < n; a++)(e = t[a]).time += i, e.delay < e.time && (e.time -= e.delay, e.func())
    },
    __interval: 10,
    __sid: -1,
    __list: [],
    ...
    copyToClipboard: function(e) {
        ...
        var n = t.style;
        n.position = "fixed", n.left = "-100%", document.body.appendChild(t), t.focus();
    ...
    getCookie: function(e) {
        ...
        if (0 <= a) {
            var o = a + n.length,
                r = i.indexOf(";", o); - 1 == r && (r = i.length), t = decodeURIComponent(i.substring(o, r))
        }
        return t
    },
    setCookie: function(e, t, n, i) {
        var a = e + "=" + encodeURIComponent(t) + ";";
        0 <= n && (a += " max-age=" + n + ";"), i && (a += " path=" + i + ";"), document.cookie = a
    },
    ...
    show: function(e, t) {
        if (aidn.adv._useAdv() && 1 != aidn.adv._e)
            if (aidn.adv._e) aidn.adv._e.show();
            else {
                var n = void 0 === t;
                ...
                var r = "";
                switch (r += '<div style="' + o + 'width: 320px;"><div id="close_adv" style="text-align: right; cursor:pointer;">', r += '<svg style="vertical-align:bottom; background:rgba(255, 255, 255, 0.6);" width="12" height="12" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill-rule="evenodd" clip-rule="evenodd"><path d="M12 11.293l10.293-10.293.707.707-10.293 10.293 10.293 10.293-.707.707-10.293-10.293-10.293 10.293-.707-.707 10.293-10.293-10.293-10.293.707-.707 10.293 10.293z"/></svg>', r += "</div>", r += '<div style="' + a + '">', r += '<script async src="//pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"><\/script>', e) {
                    case 0:
                ...
                r += "<script>(adsbygoogle = window.adsbygoogle || []).push({});<\/script>", r += "</div>", r += "</div>", (aidn.adv._e = $(r)).children("#close_adv").on("click", aidn.adv.close), n ? $("body").append(aidn.adv._e) : t.append(aidn.adv._e)
            }
    },
    hide: function() {
    ...
    showLink: function(e, t) {
        if (aidn.adv._useAdv() && 1 != aidn.adv._el)
            if (aidn.adv._el) aidn.adv._el.show();
                ...
                var n = "";
                n += '<div style="width:200px;"><div id="close_adv_link" style="text-align: right; cursor:pointer;">', n += '<svg style="vertical-align:bottom;" width="12" height="12" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill-rule="evenodd" clip-rule="evenodd"><path d="M12 11.293l10.293-10.293.707.707-10.293 10.293 10.293 10.293-.707.707-10.293-10.293-10.293 10.293-.707-.707 10.293-10.293-10.293-10.293.707-.707 10.293 10.293z"/></svg>', n += "</div>";
                var i = "";
                aidn.util.getQuery().lc && (i = " background:rgba(0, 0, 0, 0.05);"), n += '<div style="width:200px; height:90px;' + i + '">', n += '<script async src="//pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"><\/script>', n += '<ins class="adsbygoogle" style="display:inline-block;width:200px;height:90px" data-ad-client="ca-pub-2758302531676411" data-ad-slot="3037968718"></ins>', n += "<script>(adsbygoogle = window.adsbygoogle || []).push({});<\/script>", n += "</div>", n += "</div>";
                var a = aidn.adv._el = $(n);
                a.children("#close_adv_link").on("click", aidn.adv.closeLink), 0 != t ? 1 != t ? 2 != t ? e.append(a) : e.prepend(a) : e.after(a) : e.before(a)
            }
    },
    hideLink: function() {
    ...
    shareTw: function(e, t, n, i, a) {
        ...
        var d = 0;
        for (var s in r) o += 0 == d ? "?" + s + "=" + r[s] : "&" + s + "=" + r[s], d++;
...
function __checkInit() {
    if ("undefined" == typeof jQuery) setTimeout(__checkInit, 10);
        ...
        e && "string" == typeof e && ($.ajax({
            ...
            if (8 <= e && aidn.util.checkStandAlone()) {
                var t = "_start_url";
                localStorage.getItem(t) || localStorage.setItem(t, location.href), document.addEventListener("visibilitychange", function(e) {
            ...
            if (12.2 <= e) {
                for (var o = ["/mikuboard", "/vtofu", "/omikuji", "/momoko_vr", "/catsphere", "/shake", "/m/nijimi"], r = location.href, d = !1, s = 0, l = 0; l < o.length; l++) 0 < r.indexOf(o[l]) && (d = !0, s = o[l].split("/").length - 2);
                ...
                if (d) {
                    ...
                    window.addEventListener("deviceorientation", function e(t) {
                        clearTimeout(u), window.removeEventListener("deviceorientation", e)
                    })
                }
            }
            if (_isJapanese || null != document.getElementById("google_translate_element") && $.getScript("//translate.google.com/translate_a/element.js?cb=__googleTranslateElementInit", function() {
                    ...
                    setInterval(function() {
                        $(".goog-te-banner-frame").length && ("none" == $(".skiptranslate").css("display") ? e && ("block" == $("#bt_menu").css("display") ? $("#menu, #bt_menu").css("top", 0) : $("#menu").css("top", 0)) : (e && ("block" == $("#bt_menu").css("display") ? $("#menu, #bt_menu").css("top", 39) : $("#menu").css("top", 39)), $(window).width() < 480 ? $("iframe:first").contents().find(".goog-te-button").css("display", "none") : $("iframe:first").contents().find(".goog-te-button").css("display", "block"), 0 != t.tw && $("#goog-gt-tt").css({
                            display: "none",
                            opacity: 0
                        })))
                    }, 100);
                ...
                $("a[href='http://twitter.com/daniwell_aidn']").attr("target", "_self"), $("a[href='https://twitter.com/daniwell_aidn']").attr("target", "_self"), h(), setTimeout(h, 500)
            }
            if (0 < $("#aidn").length && (_active = !1), 0 < $("#aidnx").length && (_active = !1, $("#bt_menu").on("click", function() {
                    $("#menu").stop().slideToggle(150)
                })), !_active) {
                var f = aidn.constant.advUrlEn;
                aidn.util.checkJapanese() && (f = aidn.constant.advUrlJa);
                var v = "";
                if (v += '<a href="' + f + '" target="_blank"><div class="adv_con">', v += '<p class="text">' + aidn.constant.advTex + "</p>", v += '<p class="image"><img src="' + aidn.constant.advImg + '" alt="' + aidn.constant.advAlt + '" /></p>', v += "</div></a>", 0 < $("#adsen").length && aidn.adv.show(0, $("#adsen")), 0 < $(".adv").length) $(".adv").html(v), $("body").css("overflow", "auto"), aidn.adv.showLink($(".adv"), 1);
                else {
                    var g = $("#common_back");
                    0 < g.length && (v = '<div class="adv"><div class="hr_top"></div>' + v + "</div>", $("body").css("overflow", "auto"), g.after(v))
                }
            }
        })
    }
    ...
    (this._audio = u).addEventListener("playing", function() {
        ...
        if (!a) return !1;
        s = t, u.src = a, u.onprogress = function() {
            try {
                n && n(u.buffered.end(0) / u.duration)
            } catch (e) {}
        }, u.load()
    }, this.play = function(t, e, n, i, a) {
        void 0 === t && (t = 0), void 0 === e && (e = !1), void 0 === i && (i = 0), void 0 === a && (a = 1), l = n, d = e, r = 1e6;
        try {
            u.currentTime = t
        } catch (e) {
            aidn.log(e), o = t
        }
        u.play(), 0 < i && "undefined" != typeof jQuery ? (c.volume = 0, $(c).stop().animate({
            volume: a
    ...
    aidn.audio.init();
    var f, v, u, h, g, m, p, w, b, _, y, x, t, E = this,
        k = [],
        O = 0,
        A = 100,
        S = -1,
    ...
    this.load = function(e, u, t, n) {
        ...
        if (!f) return !1;
        f.createBufferSource().start(0), v = null;
        var l = aidn.audio.getPath(e);
        if (!l && !a) return !1;

        function c() {
            var e;
            e = a ? i.buffer : h.response, f.decodeAudioData(e, function(e) {
                if (0 <= S) {
                ...
                A = (v = e).duration, u && u(v), F && (F = !1, E.play(p, w, b, _, y, x))
            }, function() {})
        }
        if (a) c();
        else {
            var h = new XMLHttpRequest;
            h.open("GET", l, !0), h.responseType = "arraybuffer", h.onload = c, h.onprogress = function(e) {
                n && n(e.loaded / e.total)
            }, h.send()
        }
        return !0
    }, this.play = function(e, t, n, i, a, o) {
        if (p = e, w = t, b = n, _ = i, y = a, x = o, !v) return F = !0, void console.log('call "load" method before "play"');
        void 0 === e && (e = 0), void 0 === t && (t = !1), void 0 === i && (i = 0), void 0 === a ? a = I : I = a, void 0 === o && (o = 0), (u = f.createBufferSource()).buffer = v, u.loop = t, u.onended = T, g || (g = f.createGain());
        var r = [u, g];
        r = r.concat(k), h && r.push(h), m && r.push(m);
        for (var d = 1; d < r.length; d++) {
            var s = r[d - 1],
                l = r[d];
            s.connect(l), d == r.length - 1 && l.connect(f.destination)
        }
        if (u.start ? u.start(f.currentTime + o, e) : u.noteOn(e), O = f.currentTime - e, this._source = u, this.nodeGain = g, 0 < i && "undefined" != typeof jQuery ? (E.volume = 0, $(E).stop().animate({
                volume: a
        ...
        return (void 0 === e || e <= 0) && (e = "equalpower"), 0 < e && (e = "HRTF"), (h = f.createPanner()).panningModel = e, this.nodePanner = h
    }, this.initBiquadFilter = function(e) {
        return void 0 === e && (e = 0), (m = f.createBiquadFilter()).type = e, m
    ...
    var i, a, o, r = 2;
    if ("undefined" != typeof swfobject && swfobject.hasFlashPlayerVersion(10) && null != e ? r = 0 : aidn.util.webaudio && (r = 1), 0 <= n && n <= 2 && (r = n), ___flash_audioLoadComplete = function() {
            a()
        ...
        var l = setInterval(function() {
            document.getElementById("flash_audio").loadFunc && (clearInterval(l), i = document.getElementById("flash_audio"), t(r))
        }, 100)
    } else i = 1 == r ? new aidn.WebAudio : new aidn.Audio, this.audio = i, t && setTimeout(function() {
        t(r)
    }, 10);
    this.load = function() {
        var e;
        if ("string" == typeof arguments[0] && (arguments[0] = [arguments[0]]), 0 == r) {
        ...
        0 == r && arguments[2] && (o = arguments[2], arguments[2] = "___flash_audioPlay"), (i.playFunc || i.play).apply(i, arguments)
    }, this.stop = function() {
