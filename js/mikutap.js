...
var MainManager = function () {
        ...
        function i() {
            (x = 1),
                ...
                p
                    ? ($("#scene_loading").stop().css("display", "none"), $("#bt_back").stop().css("display", "none"), B && $("#bt_fs").stop().css("display", "none"), $("#scene_main .set").stop().css("display", "none"))
        ...
        var m,
                ...
                this.init = function (n, a) {
                    (e = a),
                        (function (n) {
                            ...
                            (instancePlayMusic = new WebAudioManager()).load("data/main/main.json", a, t, i);
                        })(n);
                };
                this.play = function (keyCode, a) {
                    // console.log('in func play' ,keyCode ,a)
                    var e = 1e3 * (aidn.___waContext.currentTime + h[keyCode] - m),
                        t = Math.floor(e / f);
                    t == r && 0 <= l && instancePlayMusic.stop(l), (r = t), (l = keyCode);
                    var i = f - (e % f);
                    // cons
                    instancePlayMusic.play(keyCode, i / 1e3, d[keyCode]);
                };
                var s = 32;
                this.length = s;
                for (var d = [], h = [], n = 0; n < s; n++) (d[n] = 1), (h[n] = 0.05);
                for (h[6] = 0.08, h[20] = 0.1, h[23] = 0.1, d[1] = 1.3, d[2] = 1.6, d[3] = 1.35, d[5] = 1.7, d[9] = 0.8, d[17] = 0.8, d[22] = 0.9, d[25] = 0.7, d[29] = 1.2, n = 0; n < s; n++) d[n] *= 1.2;
                var c,
                    e,
                    f = 6e4 / 280;
            })(),
            g = new (function () {
                ...
                var s = function (n, a) {
                    ...
                    n = function (n) {
                        ...
                        (this.resize = function () {
                            ...
                            (this.flash = function () {
                                ...
                                for (var n = 0; n < 3; n += 2) TweenLite.delayedCall(0.07 * n, a), TweenLite.delayedCall(0.07 * (n + 1), e);
                            }),
                    ...
                    d = function (n, a) {
                        console.log("ddddd nha")
                        function e() {
                            var n,
                                a,
                                e,
                                t = 1.3 * d;
                            if ((f.clear(), f.beginFill(0), f.moveTo(0, 0), 0 == o)) for (var i = 0; i < c.rotation; i += 30) (n = ((s * i + l) * Math.PI) / 180), (a = Math.cos(n) * t), (e = Math.sin(n) * t), f.lineTo(a, e);
                            else for (i = 360; c.rotation < i; i -= 30) (n = ((s * i + l) * Math.PI) / 180), (a = Math.cos(n) * t), (e = Math.sin(n) * t), f.lineTo(a, e);
                    ...
                    t = function (n, a) {
                        ...
                        this.play = function (n) {
                            (e = n),
                                (function () {
                                    p.setChildIndex(y, p.children.length - 1), (y.visible = !0), (y.x = G / 2), (y.y = A / 2), (y.rotation = 0.5 * Math.PI * Math.floor(4 * Math.random()));
                                    for (
                                        var n, a = Math.floor(7 * Math.random() + 2), e = 0.8 * Math.min(G, A), t = ((v.size = e) / a) * (0.4 * Math.random() + 0.7), i = (e / a) * (0.4 * Math.random() + 0.1), o = L(), r = 0, l = 0;
                                        l <= a;
                                        l++
                                    ) {
                                        var s = (l - 0.5 * a) * t,
                ...
                function c(n, a, e) {
                    let nut  = ''
                    if(n < 17) {
                        nut  = String.fromCharCode(n + 48)
                    } else if( n > 17 ) {
                       nut  = String.fromCharCode(n + 55)
                    }

                    console.log('keycode', nut , n  )
                    ...
                    u != n &&
                        ...
                        u < 0 ||
                            (R.play(n % R.length, e),
                            (D = 90),
                            S && ((S = !1), $("#bt_back").stop().fadeOut(200, "linear"), B && $("#bt_fs").stop().fadeOut(200, "linear"), $("#scene_main .set").stop().fadeOut(200, "linear")),
                            --x <= 0 && ((i = (t = Math.floor(I.length * Math.random())) + arrayHandleAnimation.length), (C[i].length ? C[i].pop() : new I[t](b, i)).play(), (x = 12 * Math.random() + 6)),
                            (t = n % arrayHandleAnimation.length),
                            (0 < C[t].length ? C[t].pop() : new arrayHandleAnimation[t](b, t)).play()));
                    console.log("so thu tu",t)
                }
                (this.resize = function () {
                    if (w) {
                        var n = 0,
                    ...
                    (this.init = function () {
                        (w = !0), (b = new PIXI.Container()), z.addChild(b), (f = new PIXI.Container()), z.addChild(f), (T = new n(b)).setColor(4608348, 0);
                    }),
                    (this.start = function () {
                ...
                var f,
                    ...
                    arrayHandleAnimation = [
                        ...
                        function (n, a) {
                            ...
                            this.play = function () {
                                !(function () {
                                    ...
                                    for (var n = 0.6 * Math.min(G, A), a = Math.floor(5 * Math.random()) + 3, e = 360 / a, t = ((0.5 * Math.max(G, A)) / n) * (1.6 + 0.6 / a), i = 0; i <= a; i++) {
                        ...
                        function (n, a) {
                            ...
                            this.play = function () {
                                !(function () {
                                    (r.visible = !0), o.setChildIndex(r, o.children.length - 1), (r.x = 0.2 * G + 0.6 * G * Math.random()), (r.y = 0.2 * A + 0.6 * A * Math.random());
                                    var n,
                        ...
                        function (n, a) {
                            ...
                            this.play = function () {
                                !(function () {
                                    u.clear(),
                                        (u.visible = !0),
                                        Math.random() < 0.5 ? ((u.x = 0), (u.y = 0), (u.rotation = 0)) : ((u.x = G), (u.y = A), (u.rotation = Math.PI)),
                                        (c = l = 0),
                            ...
                            this.play = function () {
                                !(function () {
                                    ...
                                    a
                                        ...
                                        Math.random() < 0.5 ? ((y.rotation = 0), (y.x = 0), (y.y = 0)) : ((y.rotation = Math.PI), (y.x = G), (y.y = A));
                                    for (var i = (f = 0); i <= e; i++) {
                                        var o = {
                                                x: 0,
                                                y: 0,
        ...
        n(),
            o(),
            aidn.util.webaudio
                ? ($("#ng").css("display", "none"), $(".ok").css("display", "block"), E && $("#scene_main .attention").html("TOUCH &amp; SWIPE!"), y || $("#scene_top .attention").text("* Raise the volume and enjoy!"))
                : ($("#ng").css("display", "block"), $(".ok").css("display", "none"), y || $("#ng .atten").html("Sorry,<br>your device or browser doesn't support this site.")),
